...
// L6: T3=80% T4=100% T5=100% (target T4=50%)
// L7: T3=73% T4=100% T5=100% (target T4=35%)
// L8: T3=0% T4=80% T5=100% (target T4=25%)
// L9: T3=20% T4=93% T5=100% (target T4=15%)
// L10: T3=0% T4=13% T5=47% (target T4=8%)
...
export const levels: ReadonlyArray<LevelBuilder> = [
  make(1, [bishop(2, 6), pawn(4, 4), bishop(7, 6)]),
  make(2, [bishop(2, 6), pawn(4, 4), bishop(7, 6), knight(4, 5), pawn(5, 4)]),
  make(3, [bishop(2, 6), pawn(4, 4), bishop(7, 6), knight(4, 5), pawn(5, 4), pawn(3, 4), pawn(6, 4)], { allowedForms: ['knight'], enemiesPerTurn: 2 }),
  ...
  make(6, [bishop(2, 6), pawn(4, 4), bishop(7, 6), knight(4, 5), pawn(5, 4), pawn(3, 4), pawn(6, 4), queen(5, 6), pawn(2, 3), pawn(7, 3), knight(6, 5), bishop(3, 7), queen(4, 7), pawn(1, 4), pawn(8, 4)], { hazards: [{ file: 4, rank: 3 }, { file: 5, rank: 3 }, { file: 1, rank: 4 }, { file: 8, rank: 4 }], moveLimit: 22, allowedForms: ['knight', 'bishop'], enemiesPerTurn: 2 }),
