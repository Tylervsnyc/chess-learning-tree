...
// L5: T3=80% T4=73% T5=100% (target T4=60%)
// L6: T3=7% T4=27% T5=73% (target T4=50%)
// L7: T3=7% T4=53% T5=80% (target T4=35%)
// L8: T3=20% T4=7% T5=27% (target T4=25%)
// L9: T3=13% T4=7% T5=0% (target T4=15%)
// L10: T3=0% T4=0% T5=27% (target T4=8%)
 * L10 no-ability T5: 0%
 */
