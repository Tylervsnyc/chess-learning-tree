...
// L5: T3=93% T4=67% T5=100% (target T4=60%)
// L6: T3=13% T4=40% T5=73% (target T4=50%)
// L7: T3=27% T4=33% T5=47% (target T4=35%)
// L8: T3=0% T4=13% T5=13% (target T4=25%)
// L9: T3=33% T4=7% T5=20% (target T4=15%)
// L10: T3=0% T4=0% T5=7% (target T4=8%)
 * L10 no-ability T5: 0%
 */
