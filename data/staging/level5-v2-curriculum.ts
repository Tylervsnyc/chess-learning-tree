...
This is where you make the decision that defines the game. The sacrifice. The zwischenzug. The endgame technique.
...
They expect you to recapture. Instead, you play a stronger move first.

The surprise that changes everything.`,
          lessons: [
            {
              id: '5.10.1',
              name: 'Zwischenzug: Intro',
              description: 'The in-between move',
            ...
            {
              id: '5.10.2',
              name: 'Zwischenzug: Patterns',
              description: 'Common zwischenzug patterns',
              requiredTags: ['intermezzo'],
              ratingMin: 1450,
              ratingMax: 1575,
              minPlays: 500,
            ...
            {
              id: '5.10.3',
              name: 'Zwischenzug: Check',
              description: 'In-between check',
              requiredTags: ['intermezzo'],
              ratingMin: 1500,
              ratingMax: 1600,
              minPlays: 500,
            },
            {
              ...
              description: 'Find the surprise move',
              requiredTags: ['intermezzo'],
              ratingMin: 1525,
              ratingMax: 1625,
              minPlays: 500,
...
Master these, and you'll convert every winning position.`,
        ...
        // Section 12: Block 3 Review
        {
          ...
          isReview: true,
          themeIntroMessage: `Complex sacrifices. Zwischenzug. Theoretical endgames.
...
These techniques will elevate your game.`,
          lessons: [
            ...
            {
              id: '5.12.2',
              name: 'Review: Zwischenzug',
              description: 'The in-between moves',
              requiredTags: [],
              isMixedPractice: true,
            ...
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['sacrifice', 'intermezzo', 'rookEndgame'],
              ratingMin: 1475,
              ratingMax: 1600,
              minPlays: 500,
            },
...
Mate in 5. Double checks. Defense. Zwischenzug. Endgames.
...
The complete Level 5 experience.`,
          lessons: [
            ...
            },
            {
              id: '5.13.3',
              name: 'Mixed: Virtuoso',
              description: 'Sacrifice and intermezzo',
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['sacrifice', 'intermezzo'],
              ratingMin: 1475,
              ratingMax: 1600,
              minPlays: 500,
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['mateIn5', 'doubleCheck', 'defensiveMove', 'sacrifice', 'intermezzo'],
              ratingMin: 1500,
              ratingMax: 1600,
              minPlays: 500,
            },
...
Complete these last puzzles. Then go find someone to destroy.`,
          lessons: [
            ...
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['sacrifice', 'intermezzo', 'quietMove', 'doubleCheck'],
              ratingMin: 1500,
              ratingMax: 1625,
              minPlays: 500,
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['mateIn5', 'doubleCheck', 'defensiveMove', 'sacrifice', 'intermezzo', 'rookEndgame'],
              ratingMin: 1525,
              ratingMax: 1650,
              minPlays: 500,
            },
