...
Checkmates, tactics, endgames - anything goes. Figure out what the position needs.`,
          ...
          lessons: [
            ...
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['mateIn1', 'fork', 'skewer', 'crushing', 'rookEndgame'],
              ratingMin: 400,
              ratingMax: 750,
              minPlays: 500,
            },
...
Everything at once. You've got this.`,
          ...
          lessons: [
            ...
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['fork', 'skewer', 'hangingPiece', 'crushing'],
              excludeTags: ['mateIn1', 'mateIn2'],
              ratingMin: 450,
              ratingMax: 750,
              minPlays: 500,
            ...
            },
            {
              ...
              requiredTags: [],
              isMixedPractice: true,
              mixedThemes: ['mateIn2', 'fork', 'skewer', 'crushing', 'discoveredAttack'],
              ratingMin: 500,
              ratingMax: 800,
              minPlays: 500,
            },
