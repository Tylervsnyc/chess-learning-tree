...
export const OPENINGS_REGISTRY: OpeningConfig[] = [
  ...
  },
  {
    slug: 'witty-alien',
    name: 'Witty Alien',
    subtitle: "Streamer Witty_Alien's meme-gambit arsenal",
    moves: '1.e4 c6 2.d4 d5 3.Nd2 dxe4 4.Nxe4',
    description: "Bulgarian streamer Witty_Alien's full bag of tricks — knight sacrifices that crush the Caro-Kann and French, plus his favorite gambits as Black: the Elephant, the Englund, the Danish, and more. Unsound by the engine, lethal in bullet. Built from his real chess.com games.",
    side: 'white',
    category: '1.e4',
    color: '#8B5CF6',
    colorDark: '#6D28D9',
    ...
    variations: [
      ...
      // Two Knights Trap dropped 2026-06-04: witty_alien has only ~4 real games with the
      // 2.Nc3 move order (they transpose to the Alien's Nxf7 sac anyway). No data to teach.
      ...
      { name: 'Danish Gambit', subtitle: 'White — the two-pawn 3.c3 gambit', icon: 'lightning', hasData: true, slug: 'witty-alien-danish' },
      { name: 'Scandinavian Gambit', subtitle: 'Black vs 1.e4 — the 1...d5 gambit', icon: 'shield', hasData: true, slug: 'witty-alien-scandi' },
    ],
  ...
  },
  {
    slug: 'slav',
    name: 'Slav Defense',
    subtitle: 'Solid and flexible — the Semi-Slav gambit',
    moves: '1.d4 d5 2.c4 c6',
    description: 'The Slav Defense. Solid pawns, active pieces, and the explosive Anti-Moscow Gambit.',
    side: 'black',
    category: '1.d4',
    color: '#E67E22',
    colorDark: '#CA6F1E',
    ...
    hasData: true,
    order: 12,
    mainLine: { name: 'Semi-Slav', subtitle: '4...e6 5.Bg5 h6 — the Anti-Moscow' },
    variations: [],
  },
  {
    slug: 'kings-indian',
  ...
  },
  {
    ...
    subtitle: 'Sacrifice the center, then destroy it',
    moves: '1.d4 Nf6 2.c4 g6 3.Nc3 d5',
    description: 'Give White the center, then blow it up. A hypermodern classic favored by world champions.',
    side: 'black',
    category: '1.d4',
    color: '#9B59B6',
    colorDark: '#7D3C98',
