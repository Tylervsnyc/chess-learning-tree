...
export const PI_LESSON_1: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      hint: "The modest pawn move.",
      correctFeedback: "d6 — let them have the center.",
      wrongFeedback: "The Pirc starts with d6.",
    },
    ...
    },
    {
      ...
      hint: "Develop and pressure e4.",
      correctFeedback: "Nf6 — eyeing e4.",
      wrongFeedback: "Knight to f6 attacks the e4 pawn.",
    },
    ...
    },
    {
      ...
      hint: "Make room for the bishop.",
      correctFeedback: "g6 — the Pirc is on the board.",
...
export const PI_LESSON_2: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.after_Nf3,
      correctMove: 'Bg7',
      prompt: "The Dragon Bishop.",
      hint: "Fianchetto!",
      correctFeedback: "Bg7 — controlling the long diagonal.",
      wrongFeedback: "Bishop to g7.",
    },
    // 5.Be2
    {
      type: 'instruction',
    ...
    },
    {
      ...
      hint: "Castle!",
      correctFeedback: "Castled — fianchetto fortress complete.",
...
export const PI_PUNISH_F4: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      prompt: "Stay calm.",
      hint: "Fianchetto.",
      correctFeedback: "Bg7 — same plan, no panic.",
      wrongFeedback: "Bishop to g7.",
    },
    // 5.e5?!
    {
    ...
    },
    {
      ...
      fen: FEN.punish_after_e5,
      correctMove: 'dxe5',
      prompt: "Crack the center.",
      hint: "Capture the overextended pawn.",
      correctFeedback: "dxe5 — center demolished.",
    ...
    },
    {
      ...
      fen: FEN.punish_after_fxe5,
      correctMove: 'Nd5',
      prompt: "The dream square.",
      hint: "Knight to the center.",
      correctFeedback: "Nd5! — dominant.",
      wrongFeedback: "Nd5 — a monster in the center.",
    },
  ],
}
...
export const PI_LESSON_3: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.after_OO_w,
      correctMove: 'c5',
      prompt: "Now it's time to fight.",
      hint: "Challenge the d4 pawn!",
      correctFeedback: "c5! — the Pirc counterattack. Beautiful.",
      wrongFeedback: "c5 strikes at the center.",
    },
  ],
}
...
export const PI_AUSTRIAN_1: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      prompt: "King safety.",
      hint: "Castle.",
      correctFeedback: "Castled — safe and ready.",
      wrongFeedback: "Castle kingside.",
    },
  ],
}
...
export const PI_PUNISH_BC4: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.punishBc4_after_Bc4,
      correctMove: 'Nxe4',
      prompt: "Grab the free pawn.",
      hint: "Take on e4.",
      correctFeedback: "Nxe4! — nobody's guarding it properly.",
      wrongFeedback: "Take e4 with your knight.",
    },
    // 6.Nxe4
    {
      type: 'instruction',
    ...
    },
    {
      ...
      correctFeedback: "d5! — the fork wins material. Well played.",
      wrongFeedback: "d5 forks the knight and bishop.",
    },
  ],
}
...
export const PI_LESSON_4: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.pi4_after_Be3,
      correctMove: 'Nc6',
      prompt: "Add pressure to d4.",
      hint: "Develop to c6.",
      correctFeedback: "Nc6 — three attackers on d4.",
      wrongFeedback: "Nc6.",
    },
    // 8.Qd2
    {
    ...
    },
    {
      ...
      fen: FEN.pi4_after_Qd2,
      correctMove: 'e5',
      prompt: "The center break.",
      hint: "Blow it open!",
      correctFeedback: "e5! — the Pirc at full power.",
      wrongFeedback: "e5 challenges the center.",
    },
  ],
}
...
export const PI_AUSTRIAN_2: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.austrian2_after_Bd3,
      correctMove: 'c5',
      prompt: "The Austrian counter.",
      hint: "Same idea — c5!",
      correctFeedback: "c5! — cracking the center open.",
      wrongFeedback: "c5 attacks d4.",
    },
  ],
}
...
export const PI_CLASSICAL_1: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      hint: "Head toward c4.",
      correctFeedback: "Na5! — on the way to c4. Textbook reroute.",
      wrongFeedback: "Na5 — heading to c4.",
    },
  ],
}
...
export const PI_TEST_1: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      correctFeedback: "d6 — the Pirc way.",
      wrongFeedback: "d6.",
    },
    // 2.d4
    {
    ...
    },
    {
      ...
      fen: FEN.after_Nf3,
      correctMove: 'Bg7',
      prompt: "You've done this before.",
    ...
    },
    {
      ...
      correctFeedback: "c5! The Pirc counterattack.",
      wrongFeedback: "c5.",
    },
    // 7.Be3
    {
    ...
    },
    {
      ...
      fen: FEN.pi4_after_Qd2,
      correctMove: 'e5',
      prompt: "Time for the big move.",
      hint: "You've earned this.",
      correctFeedback: "e5! Full Pirc power.",
      wrongFeedback: "e5.",
    },
    ...
    },
    {
      ...
      fen: FEN.classical1_after_d5,
      correctMove: 'Na5',
      prompt: "Where's the knight going?",
      hint: "I'm not telling.",
      correctFeedback: "Na5! Textbook.",
      wrongFeedback: "Na5.",
    },
    ...
    },
    {
      ...
      fen: FEN.austrian2_after_Bd3,
      correctMove: 'c5',
      prompt: "Same idea, different day.",
      hint: "You're on your own!",
      correctFeedback: "c5! Same plan, different setup.",
      wrongFeedback: "c5.",
    },
    ...
    },
    {
      ...
      fen: FEN.punishBc4_after_Bc4,
      correctMove: 'Nxe4',
      prompt: "Something's wrong here...",
      hint: "Look closely.",
      correctFeedback: "Nxe4! Free pawn.",
      wrongFeedback: "Nxe4.",
    },
    // 6.Nxe4
    {
    ...
    },
    {
      ...
      prompt: "Finish them.",
      hint: "BOOM.",
      correctFeedback: "d5! Fork — you know the Pirc inside and out.",
      wrongFeedback: "d5.",
    },
  ],
}
