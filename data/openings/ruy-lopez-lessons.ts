...
export const RL_LESSON_1: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      hint: 'Pawn to the center!',
      correctFeedback: 'e4 — center control.',
      wrongFeedback: "Which pawn grabs the center?",
    },
    {
      type: 'instruction',
      fen: FEN.after_e5,
    ...
    },
    {
      ...
      hint: 'A piece that does two things at once.',
      correctFeedback: 'Nf3 — develop AND attack e5.',
      wrongFeedback: "Develop a piece toward the center.",
    },
    {
      type: 'instruction',
      fen: FEN.after_Nc6,
    ...
    },
    {
      ...
      hint: "Attack the piece that's protecting e5.",
      correctFeedback: "Bb5 — the Ruy Lopez. You're pressuring the knight that holds e5 together.",
      wrongFeedback: "Which piece is defending e5? Attack it.",
    },
...
export const RL_LESSON_2: OpeningLesson = {
  ...
  steps: [
    ...
    // 9
    {
      ...
      correctFeedback: 'e4 — center control.',
      wrongFeedback: "Grab the center with a pawn.",
    },
    ...
    // 10
    {
      ...
      wrongFeedback: "Develop a piece that also attacks e5.",
    },
    ...
    // 11
    {
      ...
      prompt: 'Pressure the defender.',
      hint: 'Bishop to b5.',
      correctFeedback: "Bb5 — targeting the knight that guards e5.",
      wrongFeedback: "Attack the piece defending e5.",
    },
    ...
    // 12
    {
      ...
      hint: 'Bishop to a4, still aimed at c6.',
      correctFeedback: "Ba4 — retreated but still pressuring.",
      wrongFeedback: "Keep the bishop aimed at the c6 knight.",
    },
    ...
    // 13
    {
      ...
      fen: FEN.after_Nf6,
      correctMove: 'O-O',
      prompt: 'King safety over pawn defense.',
      hint: 'Castle kingside.',
      correctFeedback: "O-O — king safe, Re1 is ready if e4 falls.",
      wrongFeedback: "Your king matters more than the e4 pawn.",
    },
...
export const RL_LESSON_3: OpeningLesson = {
  ...
  steps: [
    ...
    // 11
    {
      ...
      prompt: 'Retreat but stay active.',
      hint: 'Bishop to a4.',
      correctFeedback: 'Ba4 — still aimed at c6.',
      wrongFeedback: "Keep the bishop on the diagonal.",
    },
    ...
    // 12
    {
      ...
      hint: 'Castle.',
      correctFeedback: 'O-O — king safe, rook activated.',
      wrongFeedback: "Castle before the center opens.",
    },
    ...
    // 13
    {
      ...
      fen: FEN.after_Be7,
      correctMove: 'Re1',
      prompt: 'Support e4 for the d4 push.',
      hint: 'Rook to e1.',
      correctFeedback: "Re1 — supports e4 and X-rays Black's king.",
      wrongFeedback: "Which piece slides behind e4?",
    },
    ...
    // 14
    {
      ...
      fen: FEN.after_b5,
      correctMove: 'Bb3',
      prompt: "Bishop attacked — aim it at f7.",
      hint: 'Bishop to b3.',
      correctFeedback: "Bb3 — aimed at f7, Black's weakest square.",
      wrongFeedback: "Retreat the bishop toward f7.",
    },
...
export const RL_LESSON_4: OpeningLesson = {
  ...
  steps: [
    ...
    // 16
    {
      ...
      prompt: 'Prepare d4.',
      hint: 'Pawn to c3.',
      correctFeedback: 'c3 — d4 is loaded and ready.',
      wrongFeedback: "Support the d4 push with a pawn.",
      highlightSquares: ['c2', 'c3'],
    },
    // 17 — O-O auto-advance
    {
    ...
    // 18
    {
      ...
      correctMove: 'h3',
      prompt: 'Stop the pin.',
      hint: 'h3 prevents Bg4.',
      correctFeedback: "h3 — no Bg4 pin, ever. The Closed Ruy Lopez is set up. d4 is coming next!",
      wrongFeedback: "Prevent the bishop from pinning your knight.",
      highlightSquares: ['h2', 'h3'],
    },
...
export const RL_EXCHANGE_1: OpeningLesson = {
  ...
  steps: [
    ...
    // 19
    {
      ...
      fen: FEN.after_Nc6,
      correctMove: 'Bb5',
      prompt: 'Start the Ruy Lopez.',
      hint: 'Bishop to b5.',
      correctFeedback: "Bb5 — pressure on c6.",
      wrongFeedback: "Target the knight.",
      highlightSquares: ['f1', 'b5'],
    },
    // 20 — a6 auto-advance
    {
    ...
    // 21
    {
      ...
      fen: FEN.after_a6,
      correctMove: 'Bxc6',
      prompt: "Don't retreat — take the knight.",
      hint: 'Capture on c6.',
      correctFeedback: "Bxc6! The Exchange Variation. You know when to hold the bishop and when to trade it.",
      wrongFeedback: "This time, take the knight instead of retreating.",
      highlightSquares: ['b5', 'c6'],
    },
...
export const RL_EXCHANGE_2: OpeningLesson = {
  ...
  steps: [
    ...
    // 13. Play O-O
    {
      ...
      fen: FEN.exch_after_dxc6,
      correctMove: 'O-O',
      prompt: "Safety first -- get castled.",
      hint: "Castle kingside.",
      correctFeedback: "O-O! Rooks connected.",
      wrongFeedback: "Castle first.",
      highlightSquares: ['e1', 'g1'],
    },
    ...
    // 15. Play d4
    {
      ...
      fen: FEN.exch_after_f6,
      correctMove: 'd4',
      prompt: "Open the center -- White's plan in the Exchange.",
      hint: "d4.",
      correctFeedback: "d4! You know the Exchange middlegame -- castle, then strike the center.",
      wrongFeedback: "Push d4 to challenge Black's center.",
      highlightSquares: ['d2', 'd4'],
    },
...
export const RL_BERLIN_1: OpeningLesson = {
  ...
  steps: [
    ...
    // 19. Play O-O
    {
      ...
      fen: FEN.berlin_after_Nf6,
      correctMove: 'O-O',
      prompt: "Castle -- even though e4 looks like it's hanging.",
      hint: "O-O.",
      correctFeedback: "O-O! You let them take -- because you'll get it back with d4. That's the Berlin.",
      wrongFeedback: "Castle kingside -- trust the plan.",
      highlightSquares: ['e1', 'g1'],
    },
...
export const RL_BERLIN_2: OpeningLesson = {
  ...
  steps: [
    ...
    // 14 — d4
    {
      ...
      hint: "d-pawn to d4.",
      correctFeedback: "d4! — chase that knight out.",
      wrongFeedback: "Open the center while the knight is misplaced.",
    },
    // 15 — Nd6
    ...
    // 16 — Bxc6
    {
      ...
      fen: FEN.berlin_after_Nd6,
      correctMove: 'Bxc6',
      prompt: "Damage the pawn structure.",
      hint: "Trade bishop for knight on c6.",
      correctFeedback: "Bxc6 — doubled pawns for Black.",
      wrongFeedback: "Trade off the knight on c6.",
    },
    // 17 — dxc6
    ...
    // 18 — dxe5
    {
      ...
      fen: FEN.berlin_after_dxc6,
      correctMove: 'dxe5',
      prompt: "Win the center pawn.",
      hint: "Capture on e5.",
      correctFeedback: "dxe5! Berlin Endgame reached — better pawns, open lines, you know the plan.",
      wrongFeedback: "Grab the e5 pawn.",
    },
    // 19 — Nf5
    {
      type: 'instruction',
...
export const RL_MARSHALL_1: OpeningLesson = {
  ...
  steps: [
    ...
    // 16 — c3
    {
      ...
      fen: FEN.marshall_after_OO,
      correctMove: 'c3',
      prompt: "Prepare d4 — the standard plan.",
      hint: "c3 supports d4.",
      correctFeedback: "c3 — and now d5! comes crashing in. You know what's coming next time you face the Marshall.",
      wrongFeedback: "Which pawn prepares d4?",
    },
...
export const RL_OPEN_1: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.open_after_Nxe4,
      correctMove: 'd4',
      prompt: 'Counter-attack the center.',
      hint: 'd-pawn to d4.',
      correctFeedback: 'd4! — the center opens.',
      wrongFeedback: "Strike the center while their knight is misplaced.",
    },
    { type: 'instruction', fen: FEN.open_after_b5, text: 'b5.', autoAdvance: 800 },
    {
      ...
      fen: FEN.open_after_b5,
      correctMove: 'Bb3',
      prompt: 'Retreat — aim at d5 and f7.',
      hint: 'Bishop to b3.',
      correctFeedback: 'Bb3 — targeting the weak spots.',
      wrongFeedback: "Retreat the bishop to b3.",
    },
    { type: 'instruction', fen: FEN.open_after_d5, text: 'd5.', autoAdvance: 800 },
    {
      ...
      hint: 'Capture on e5.',
      correctFeedback: "dxe5 — pawn back, passed pawn, open lines, uncastled king. Black's \"free\" pawn was anything but.",
      wrongFeedback: "Take on e5 — blow the center open.",
    },
    {
      type: 'instruction',
      fen: FEN.open_after_Be6,
...
export const RL_PUNISH_F6: OpeningLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      fen: FEN.punish_after_f6,
      correctMove: 'Nxe5',
      prompt: 'Sacrifice the knight.',
      hint: 'Take on e5.',
      correctFeedback: 'Nxe5! — the trap is set.',
      wrongFeedback: "Take the pawn even though it's defended.",
    },
    { type: 'instruction', fen: FEN.punish_after_fxe5, text: 'fxe5.', autoAdvance: 800 },
    {
      ...
      fen: FEN.punish_after_fxe5,
      correctMove: 'Qh5+',
      prompt: 'Exploit the open diagonal.',
      hint: 'Queen to h5 with check.',
      correctFeedback: 'Qh5+! — no escape.',
      wrongFeedback: "Check the king through the hole f6 left behind.",
    },
    { type: 'instruction', fen: FEN.punish_after_g6, text: 'g6.', autoAdvance: 800 },
    {
      ...
      hint: 'Qxe5+ — check and attack h8.',
      correctFeedback: "Qxe5+! Knight for a rook, and Black's king is wrecked. That's why you never defend e5 with f6.",
      wrongFeedback: "Take on e5 with the queen — it's check and a fork.",
    },
  ],
}
