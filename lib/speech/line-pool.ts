...
export const AUTHORED_LINES: SpeechLine[] = [
  ...
  // ════════════════════════════════
  {
    ...
    conditions: { beats: ['opening'], movedBy: 'player' },
    priority: 50,
    source: 'authored',
  },
  {
  ...
  // ════════════════════════════════
  // GENERIC MOVES — FILLER (low priority)
  // ════════════════════════════════
  {
    id: 'generic_player_1',
    text: 'Noted.',
  ...
  {
    id: 'generic_rookie_1',
    text: "Your turn, {name}. I'll wait. Patiently. I'm very patient. It's one of my better qualities.",
  ...
  {
    id: 'generic_rookie_2',
    text: "I've moved. I have feelings about my move but I'm keeping them to myself.",
    conditions: { beats: ['early_game', 'late_game'], movedBy: 'rookie' },
    priority: 10,
    source: 'authored',
  },
  {
    id: 'generic_rookie_3',
    text: 'Your turn. Take your time. I\'ll be here. Calculating.',
    conditions: { beats: ['early_game', 'late_game'], movedBy: 'rookie' },
    priority: 10,
    source: 'authored',
  },
  {
    id: 'generic_rookie_4',
    text: "Okay your go, {name}. I'm already thinking about my next 12 moves but that's normal for me.",
    conditions: { beats: ['early_game', 'late_game'], movedBy: 'rookie' },
    priority: 10,
    source: 'authored',
  },
