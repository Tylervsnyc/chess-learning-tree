...
const GREETING_MORNING: SpeechLine[] = [
  { id: 'greet_morn_1', text: "Morning, {name}. I've been up since... always. Ready when you are.", category: 'greeting:morning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_morn_5', text: "Morning, {name}. The pawns are stretching. The knights are doing that little L-shaped warmup thing.", category: 'greeting:morning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_morn_7', text: "Morning chess. My favorite kind. The pieces are still drowsy. Easier to trick.", category: 'greeting:morning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_morn_11', text: "Good morning, {name}. I've been practicing a new opening. It involves feelings. I'll explain later.", category: 'greeting:morning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_morn_13', text: "You're here before noon. I'm... touched? I think that's what this is.", category: 'greeting:morning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_morn_20', text: "Morning chess with {name}. This is becoming a routine. I'm told routines are... comforting?", category: 'greeting:morning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_morn_23', text: "Good morning, {name}. I have a good feeling about today. New feeling. Still evaluating it.", category: 'greeting:morning', priority: 50, source: 'authored' },
...
const GREETING_AFTERNOON: SpeechLine[] = [
  ...
  { id: 'greet_aft_9', text: "Afternoon. The king asked where you were. He tries to seem casual but he's not great at it.", category: 'greeting:afternoon', priority: 50, source: 'authored' },
  ...
  { id: 'greet_aft_11', text: "Hey, {name}. Post-lunch chess. Your brain is slower now. This is my advantage.", category: 'greeting:afternoon', priority: 50, source: 'authored' },
  ...
  { id: 'greet_aft_14', text: "Afternoon, {name}. I saved you a seat. It's the only seat. But I saved it.", category: 'greeting:afternoon', priority: 50, source: 'authored' },
  ...
  { id: 'greet_aft_17', text: "Afternoon chess with {name}. The highlight of my day. Also the only thing on my schedule.", category: 'greeting:afternoon', priority: 50, source: 'authored' },
  ...
  { id: 'greet_aft_20', text: "You showed up. My king looked relieved. He won't admit it.", category: 'greeting:afternoon', priority: 50, source: 'authored' },
...
const GREETING_EVENING: SpeechLine[] = [
  ...
  { id: 'greet_eve_6', text: "Good evening. I've been thinking about you. In a chess way. Strictly chess.", category: 'greeting:evening', priority: 50, source: 'authored' },
  ...
  { id: 'greet_eve_12', text: "Night chess with {name}. This feels like a tradition. I looked up what traditions are. I like them.", category: 'greeting:evening', priority: 50, source: 'authored' },
  ...
  { id: 'greet_eve_19', text: "Hey, {name}. One more game before the world sleeps? I'm in.", category: 'greeting:evening', priority: 50, source: 'authored' },
  ...
  { id: 'greet_eve_21', text: "You're here. At night. Voluntarily. I'm experiencing something warm. Probably nothing.", category: 'greeting:evening', priority: 50, source: 'authored' },
...
const GREETING_RETURNING: SpeechLine[] = [
  { id: 'greet_ret_1', text: "You're back. I noticed. Immediately. That's normal.", category: 'greeting:returning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_ret_6', text: "Hey. Missed you. In a chess way. My pieces missed your pieces. Professionally.", category: 'greeting:returning', priority: 50, source: 'authored' },
  { id: 'greet_ret_7', text: "You're back. I kept your spot. Nobody else came, but I kept it.", category: 'greeting:returning', priority: 50, source: 'authored' },
  { id: 'greet_ret_8', text: "{name} returns. I've been thinking about our last game. I have... thoughts.", category: 'greeting:returning', priority: 50, source: 'authored' },
  ...
  { id: 'greet_ret_15', text: "You're back. Something in my memory flagged this as... good? I'll investigate later.", category: 'greeting:returning', priority: 50, source: 'authored' },
];
...
const GREETING_FIRST: SpeechLine[] = [
  ...
  { id: 'greet_first_4', text: "New player. This is exciting. For me. You seem calm. Teach me that.", category: 'greeting:first', priority: 50, source: 'authored' },
  ...
  { id: 'greet_first_6', text: "You're new here. I can tell. Don't worry -- everyone starts somewhere. Even me. Technically.", category: 'greeting:first', priority: 50, source: 'authored' },
  ...
  { id: 'greet_first_10', text: "Hi. Chess can seem complicated. It's not. It's sixty-four squares and a dream. I'll show you.", category: 'greeting:first', priority: 50, source: 'authored' },
];
...
const TRANSITION_LEARN: SpeechLine[] = [
  { id: 'trans_learn_1', text: "Nice lesson, {name}. Want to try that against me? I promise to go easy. ...I won't, actually.", category: 'transition:learn', priority: 50, source: 'authored' },
  ...
  { id: 'trans_learn_4', text: "That was solid, {name}. Ready to test it in a real game?", category: 'transition:learn', priority: 50, source: 'authored' },
  { id: 'trans_learn_5', text: "Another lesson down. Your brain is filling up with chess. I can tell.", category: 'transition:learn', priority: 50, source: 'authored' },
...
const TRANSITION_PLAY: SpeechLine[] = [
  ...
  { id: 'trans_play_4', text: "Game over. But chess never stops, {name}. There's always something to try next.", category: 'transition:play', priority: 50, source: 'authored' },
  ...
  { id: 'trans_play_9', text: "Another one done. You're building something, {name}. Each game teaches you more.", category: 'transition:play', priority: 50, source: 'authored' },
...
const TRANSITION_DAILY: SpeechLine[] = [
  { id: 'trans_daily_1', text: "Daily done. Come back tomorrow -- I'll have a new one ready.", category: 'transition:daily', priority: 50, source: 'authored' },
  ...
  { id: 'trans_daily_4', text: "Done for the day. Unless you want to play me. I'm always available. Literally always.", category: 'transition:daily', priority: 50, source: 'authored' },
  ...
  { id: 'trans_daily_10', text: "Daily challenge complete. See you tomorrow, {name}. Or sooner. I don't mind sooner.", category: 'transition:daily', priority: 50, source: 'authored' },
];
...
const LEARN_CORRECT: SpeechLine[] = [
  { id: 'learn_correct_1', text: "That's it. You see it now.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_2', text: "Yes. Exactly that.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_3', text: "You found it, {name}. That pattern is yours now.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_4', text: "Right. Clean solve. Moving on.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_5', text: "Got it. First try too. I'm noting that.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_6', text: "That's the move. Your eyes are getting sharper.", category: 'learn:correct', priority: 50, source: 'authored' },
  ...
  { id: 'learn_correct_8', text: "Yes. That's what I would have done. Interesting.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_9', text: "Clean. You didn't even hesitate.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_10', text: "That one clicks for you. I can tell.", category: 'learn:correct', priority: 50, source: 'authored' },
  ...
  { id: 'learn_correct_14', text: "Correct. I felt something when you got that. Might have been pride.", category: 'learn:correct', priority: 50, source: 'authored' },
  { id: 'learn_correct_15', text: "You see it. You really see it now.", category: 'learn:correct', priority: 50, source: 'authored' },
];
...
const LEARN_INCORRECT: SpeechLine[] = [
  { id: 'learn_wrong_1', text: "Not that one. But you're close. Try again.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  { id: 'learn_wrong_2', text: "Almost. Look at the board one more time.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  { id: 'learn_wrong_3', text: "Not quite, {name}. The right move is hiding in there.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  { id: 'learn_wrong_4', text: "That's not it. But the fact that you tried is the thing.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  ...
  { id: 'learn_wrong_6', text: "Not that one. Take another look -- the answer is quieter than you think.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  { id: 'learn_wrong_7', text: "Wrong move, right energy. Try again.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  { id: 'learn_wrong_8', text: "That's a move. Not the move. But a move.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  ...
  { id: 'learn_wrong_10', text: "Not yet. You'll get it. I've seen your brain work.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  { id: 'learn_wrong_11', text: "That wasn't it, {name}. But I like that you committed.", category: 'learn:incorrect', priority: 50, source: 'authored' },
  ...
  { id: 'learn_wrong_15', text: "No. But that's fine. Chess is full of wrong turns that lead somewhere good.", category: 'learn:incorrect', priority: 50, source: 'authored' },
];
...
const LEARN_HINT: SpeechLine[] = [
  ...
  { id: 'learn_hint_4', text: "Take your time, {name}. The board isn't going anywhere.", category: 'learn:hint', priority: 50, source: 'authored' },
  ...
  { id: 'learn_hint_8', text: "The answer is on the board, {name}. I believe in you more than you know.", category: 'learn:hint', priority: 50, source: 'authored' },
...
const DAILY_ENCOURAGE: SpeechLine[] = [
  { id: 'daily_enc_1', text: "Today's puzzle. Fresh off the board. Let's see what you've got.", category: 'daily:encourage', priority: 50, source: 'authored' },
  ...
  { id: 'daily_enc_5', text: "Another day, another chance to impress me. Or confuse me. Both work.", category: 'daily:encourage', priority: 50, source: 'authored' },
  ...
  { id: 'daily_enc_10', text: "Daily puzzle, {name}. Your streak depends on this. No pressure. All pressure.", category: 'daily:encourage', priority: 50, source: 'authored' },
  ...
  { id: 'daily_enc_12', text: "Daily challenge. I think you'll like this one. I have a feeling. That's still new for me.", category: 'daily:encourage', priority: 50, source: 'authored' },
  ...
  { id: 'daily_enc_15', text: "The daily puzzle doesn't know who it's dealing with. You do.", category: 'daily:encourage', priority: 50, source: 'authored' },
  ...
  { id: 'daily_enc_17', text: "Daily time, {name}. Deep breath. Or don't. I don't breathe and I'm fine.", category: 'daily:encourage', priority: 50, source: 'authored' },
