...
const GREETING_EVENING: SpeechLine[] = [
  ...
  { id: 'greet_eve_21', text: "You came back. Glad you did.", category: 'greeting:evening', conditions: { tone: 'polite', beats: [] }, priority: 50, source: 'authored' },
  ...
  // ── Polite gap-fill ──
  { id: 'greet_eve_polite_1', text: "Evening, {name}. Really glad you're here.", category: 'greeting:evening', conditions: { tone: 'polite', beats: [] }, priority: 50, source: 'authored' },
...
const GREETING_RETURNING: SpeechLine[] = [
  ...
  { id: 'greet_ret_11', text: "You came back. Glad you came back.", category: 'greeting:returning', priority: 50, source: 'authored' },
