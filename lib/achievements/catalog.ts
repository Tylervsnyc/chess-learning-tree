...
export const ACHIEVEMENT_CATALOG: AchievementDef[] = [
  ...
  },
  {
    ...
    description: 'Exhibition rounds. No stakes, all heart. You fight me when nobody is even counting, and I notice.',
  ...
  },
  {
    ...
    description: 'Ten checks in one game. My king filed a complaint. It was denied.',
  ...
  },
  {
    ...
    category: 'dedication',
    name: 'Both Barrels',
    description: 'A workout AND Chess Boxing on the same day. You did the whole sport in one day. On purpose.',
