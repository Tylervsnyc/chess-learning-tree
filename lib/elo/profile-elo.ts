 ...
 * GET /api/profile/elo and GET /api/profile/dashboard. Derived (not stored —
 * see RULES.md §20) by replaying the user's puzzle attempts and Rookie games
 * through an Elo model. See lib/elo/estimate.ts.
 *
...
export const runEloCompute = async (userId: string) => {
