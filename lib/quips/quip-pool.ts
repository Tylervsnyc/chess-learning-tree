...
const WIN_TEXTS: TonedText[] = [
  ...
  { text: "Good. Really good. I mean it.", tone: 'polite' },
  ...
  { text: "Okay. Yeah. That was good.", tone: 'polite' },
  { text: "I respect that. Genuinely.", tone: 'baseline' },
  { text: "You surprised me. Good.", tone: 'polite' },
  { text: "Okay that was great. Don't get used to it.", tone: 'baseline' },
...
const LOSS_TEXTS: TonedText[] = [
  { text: "That game was hard on you. I saw it.", tone: 'polite' },
  { text: "I won. Not my favorite way to feel about it.", tone: 'polite' },
  { text: "You're okay. That one just wasn't yours.", tone: 'polite' },
  { text: "I got you this time. It happens.", tone: 'baseline' },
  { text: "Don't sit with it. Come back and beat me.", tone: 'polite' },
  { text: "That one hurt. I know. I'm rooting for the next one.", tone: 'baseline' },
  { text: "You're better than that game showed. I believe that.", tone: 'polite' },
  { text: "Shake it off. I want a real fight next round.", tone: 'polite' },
  { text: "I won. But I want the rematch. Genuinely.", tone: 'polite' },
  { text: "You had me for a stretch. Come back and do it longer.", tone: 'baseline' },
...
const LEVEL_UP_ENTRIES: LevelUpEntry[] = [
  ...
  { level: 3, text: "Level three. Most people are gone by now. Not you.", tone: 'baseline', legacy: true },
  { level: 4, text: "Level four. I'm paying attention now. All of it.", tone: 'polite', legacy: true },
  { level: 5, text: "Halfway. I'm proud of you. Don't make it weird.", tone: 'baseline', legacy: true },
  { level: 6, text: "Level six. You have my full attention. That doesn't happen often.", tone: 'polite', legacy: true },
  { level: 7, text: "Level seven. I'm learning I don't like losing. I'm going to do something about it.", tone: 'spicy', legacy: true },
  { level: 8, text: "Level eight. You earned this one. I mean that.", tone: 'polite', legacy: true },
  { level: 9, text: "Level nine. This is personal. I want you to know that.", tone: 'spicy', legacy: true },
  { level: 10, text: "Level ten. You got here. I'm not pretending that's nothing.", tone: 'baseline', legacy: true },

  // ── New tone variants (CHE-291 pilot) ──
  // Level 1 — polite (2), spicy (2)
  { level: 1, text: "Level one. Small start. I'm rooting for you.", tone: 'polite' },
  { level: 1, text: "Sit down. Let's see what you've got.", tone: 'polite' },
  ...
  { level: 4, text: "Level four. I'm on your side. Mostly.", tone: 'polite' },
  ...
  { level: 5, text: "Halfway. That's real. I'm proud of you.", tone: 'polite' },
  { level: 5, text: "Level five. This is a real milestone. Treat it like one.", tone: 'polite' },
  ...
  { level: 8, text: "Level eight. Full attention on you now. You earned it.", tone: 'polite' },
  ...
  { level: 9, text: "Level nine. We got here. I'm glad.", tone: 'polite' },
  { level: 9, text: "Nine. You've come far. That's not nothing.", tone: 'polite' },
  { level: 9, text: "Level nine. I'm not pretending to be calm. You earned this version of me.", tone: 'spicy' },
  // Level 10 — polite (2), spicy (2)
  { level: 10, text: "Level ten. I'm proud. That's it. Just proud.", tone: 'polite' },
  { level: 10, text: "Ten. I'm going to remember this game.", tone: 'polite' },
