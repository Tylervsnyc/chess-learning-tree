...
| **IG ops** | CLAUDE.md edit + deleted `ig-upload-queue.ts` (replaced by `ig-refill.ts`), `ig-insights.ts`, `ig-push-difficult.ts`, `ig-recaption-queue.ts` | Commit together — the CLAUDE.md edit documents the script swap, they must land as one |
