...
const ROUTES: Route[] = [
  ...
  { label: 'Workout report', url: '/workout/report?id=09071a4e-4470-4d92-92c2-6cf5ece81865', group: 'Primary', note: 'post-workout miss report (red = yours, green = answer); needs sign-in as the session owner' },
  ...
  { label: 'Box settings', url: '/box/settings?boxapp=frame', group: 'Primary', note: 'handle, crew, camera, leaderboard opt-in' },
  { label: 'Box profile', url: '/box/profile?boxapp=frame', group: 'Primary', note: 'Chess Boxing profile tab' },
  { label: 'Box clock', url: '/box/clock?boxapp=frame', group: 'Primary', note: 'Chess Clock + Boxing Timer modes; owns the viewport (no tab bar)' },
