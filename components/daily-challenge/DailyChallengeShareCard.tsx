...
// SVG chess pieces - clean vector graphics
    ...
    >
      ...
      <div
        style={{
          ...
          right: 0,
          height: 8,
          background: 'linear-gradient(90deg, #FF9600, #FF6B6B)',
        }}
      />
      ...
      <div
        style={{
          ...
          border: '4px solid rgba(255,150,0,0.3)',
        }}
      >
        <div
          style={{
        ...
        >
          in {formatTime(timeMs)}
        </div>
      </div>

      {/* Beat percentage or URL */}
      {globalPct !== null && globalPct !== undefined && globalPct > 0 ? (
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 48 }}>Beat </span>
          <span style={{ color: '#58CC02', fontWeight: 700, fontSize: 64 }}>{globalPct}%</span>
          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 48 }}> of players</span>
        </div>
      ) : (
        <div
          style={{
